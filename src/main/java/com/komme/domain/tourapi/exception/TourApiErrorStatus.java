...
public enum TourApiErrorStatus implements BaseStatus {
    ...
    KAKAO_LOCAL_RESPONSE_INVALID(HttpStatus.BAD_GATEWAY, "TOUR_502_5", "카카오 로컬 API 응답이 올바르지 않습니다."),
    ...
    KAKAO_LOCAL_CONNECTION_FAILED(HttpStatus.BAD_GATEWAY, "TOUR_502_10", "카카오 로컬 API 연결에 실패했습니다.");

...
public final class TourApiRedisKeys {
    ...
    private static final String RELATED_SPOT_BY_AREA_KEY_PREFIX = "tourapi:related-spot:area:";
    private static final String RELATED_SPOT_BY_KEYWORD_KEY_PREFIX = "tourapi:related-spot:keyword:";
    ...
    // 지역기반 연관 관광지 목록 캐시 키 생성
    public static String relatedSpotByArea(String areaCode, String sigunguCode) {
        return RELATED_SPOT_BY_AREA_KEY_PREFIX + areaCode + ":" + sigunguCode;
    }

    // 키워드기반 연관 관광지 목록 캐시 키 생성
    public static String relatedSpotByKeyword(String keyword) {
        return RELATED_SPOT_BY_KEYWORD_KEY_PREFIX + keyword;
    }
